(function() {
	...
	module.exports = function(http, db) {
		...
		io.on('connection', function(socket) {
			...
			socket.on('veto', function(restaurantData) {

				var room = getNonIdRoom(socket);
				io.to(room).emit('killedlRestaurant');
